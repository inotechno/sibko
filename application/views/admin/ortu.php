      ...
      <div class="row">
        <div class="col-md">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row" id="show_data_ortu">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h3 class="modal-title" id="modal-title-default">Tambah Data ortu</h3>
                      ...
                      <div class="col-md">
                        <div class="row">
                          ...
                          <div class="col-md">
                            ...
                            <select class="form-control form-control-sm select mb-1" name="pekerjaan">
                              <option></option>
      ...
      <div class="modal fade" id="update-modal" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h3 class="modal-title" id="modal-title-default">Update Data Orang Tua</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
